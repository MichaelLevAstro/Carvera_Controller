...
class BoreParameterDefinitions:
    ...
    SamplePoints = ProbeSettingDefinition(
        "P",
        "Samples",
        False,
        "Number of points to probe around a round bore for the least-squares circle fit "
        "(minimum 3). More points average out bore form error for a more accurate centre.",
        "4",
    )
